...
ffmpeg -c:v libvpx-vp9 -i 云中秘境.webm -c:v prores_ks -profile:v 4444 -pix_fmt yuva444p10le -alpha_bits 16 云中秘境.mov
ffmpeg -c:v libvpx-vp9 -i 钻石邮轮.webm -c:v prores_ks -profile:v 4444 -pix_fmt yuva444p10le -alpha_bits 16 -an 钻石邮轮.mov
