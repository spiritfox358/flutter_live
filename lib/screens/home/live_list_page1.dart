...
class LiveListPage1 extends StatefulWidget {
  const LiveListPage1({super.key});

  @override
  State<LiveListPage1> createState() => _LiveListPageState1();
}

class _LiveListPageState1 extends State<LiveListPage1> {
  // 模拟直播列表数据
  final List<Map<String, dynamic>> _liveRooms = List.generate(10, (index) {
    return {
      "username": "主播 No.${index + 1}",
      "title": _getRandomTitle(index),
      "coverUrl": "https://picsum.photos/seed/${index + 200}/400/600",
      // 竖屏随机图
      "avatarUrl": "https://picsum.photos/seed/${index + 500}/100",
      "viewers": "${Random().nextInt(90) + 1}.${Random().nextInt(9)}k",
      // 例如 1.2k
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                const LiveStreamingPage(userId: "", userName: "", isHost: false, roomId: '',),
          ),
        );
      },
      child: Container(
